...
namespace WAFERLG {
		  ...
		  dl->qp_scalar)
  {
    ...
    std::string typ = cond_list->get("Psi1 Type", "Constant"); 
  ...
  getValidPsi1Parameters() const
  {
    ...
    valid_pl->set<std::string>("Psi1 Type", "Constant",
			       "Constant psi1 across the element block");

    valid_pl->set<double>("Psi1", 1.0, "Constant psi1 value");
    return valid_pl;
  }
  //**********************************************************************
