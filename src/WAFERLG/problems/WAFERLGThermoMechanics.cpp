...
#include "WAFERLGThermoMechanics.hpp"
...
WAFERLGThermoMechanics(const Teuchos::RCP<Teuchos::ParameterList>& params_,
...
{
  ConstructEvaluatorsOp<WAFERLGThermoMechanics> op(
...
// Dirichlet BCs
void Albany::WAFERLGThermoMechanics::constructDirichletEvaluators(
...
// Neumann BCs
void Albany::WAFERLGThermoMechanics::constructNeumannEvaluators(
...
Albany::WAFERLGThermoMechanics::getValidProblemParameters() const
{
  Teuchos::RCP<Teuchos::ParameterList> validPL =
    this->getGenericProblemParams("ValidWAFERLGThermoMechanicsParams");
