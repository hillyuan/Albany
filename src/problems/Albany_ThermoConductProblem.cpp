...
Albany::ThermoConductProblem::
ThermoConductProblem( const Teuchos::RCP<Teuchos::ParameterList>& params_,
  ...
  const Teuchos::RCP<Teuchos::ParameterList>& responseList)
{
  ...
  ConstructEvaluatorsOp<ThermoConductProblem> op(
...
// Dirichlet BCs
void
Albany::ThermoConductProblem::constructDirichletEvaluators(const std::vector<std::string>& nodeSetIDs)
{
...
// Neumann BCs
void
Albany::ThermoConductProblem::constructNeumannEvaluators(const Teuchos::RCP<Albany::MeshSpecsStruct>& meshSpecs)
{
...
Albany::ThermoConductProblem::getValidProblemParameters() const
{
  Teuchos::RCP<Teuchos::ParameterList> validPL =
    this->getGenericProblemParams("ValidThermoConductProblemParams");
