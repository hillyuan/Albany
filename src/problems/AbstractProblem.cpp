...
Albany::xyAbstractProblem::xyAbstractProblem(
...
unsigned int
Albany::xyAbstractProblem::numEquations() const
{
...
Albany::xyAbstractProblem::getSideSetEquations() const
{
  return sideSetEquations;
}

void
Albany::xyAbstractProblem::setNumEquations(const int neq_)
{
  neq = neq_;
...
Albany::xyAbstractProblem::getSolutionMethod()
{
    return SolutionMethodName;
}

Teuchos::ArrayRCP<Teuchos::RCP<PHX::FieldManager<PHAL::AlbanyTraits> > >
Albany::xyAbstractProblem::getFieldManager()
{ return fm; }

Teuchos::RCP<PHX::FieldManager<PHAL::AlbanyTraits> >
Albany::xyAbstractProblem::getDirichletFieldManager()
{ return dfm; }

Teuchos::ArrayRCP<Teuchos::RCP<PHX::FieldManager<PHAL::AlbanyTraits> > >
Albany::xyAbstractProblem::getNeumannFieldManager()
{ return nfm; }

Teuchos::RCP<Teuchos::ParameterList>
Albany::xyAbstractProblem::getGenericProblemParams(std::string listname) const
{
