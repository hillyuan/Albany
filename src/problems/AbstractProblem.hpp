...
#ifndef XYFEM_ABSTRACTPROBLEM_HPP
#define XYFEM_ABSTRACTPROBLEM_HPP
...
class xyAbstractProblem {
 ...
 private:
  ...
  xyAbstractProblem();
  xyAbstractProblem(const xyAbstractProblem&);

  //! Private to prohibit copying
  xyAbstractProblem&
  operator=(const xyAbstractProblem&);
};
