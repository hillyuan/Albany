...
#ifndef PHAL_THERMOCONDUCTRESID_HPP
#define PHAL_THERMOCONDUCTRESID_HPP
...
class ThermoConductResid : public PHX::EvaluatorWithBaseImpl<Traits>,
		    public PHX::EvaluatorDerived<EvalT, Traits>  {

public:

  ThermoConductResid(const Teuchos::ParameterList& p);
